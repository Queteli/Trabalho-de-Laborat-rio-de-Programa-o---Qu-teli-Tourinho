...
# Requisito 3.2.1: Função carregar() [cite: 26]
def carregar():
...
# Requisito 3.2.2: Função salvar(lista) [cite: 28]
def salvar(lista):
    with open(ARQUIVO_JSON, 'w', encoding='utf-8') as f:
        json.dump(lista, f, indent=4, ensure_ascii=False)

# Requisito 3.2.3: Função listar(lista) [cite: 29]
def listar(lista):
...
# Requisito 3.2.4: Função criar(lista) [cite: 30]
def criar(lista):
    ...
    # Requisito 3.5: Tratamento de erros e campos vazios [cite: 47, 50]
    ...
    try:
        ...
        # Requisito 3.1: Dicionário para representar cada item [cite: 22]
        produto = {
            'id': novo_id,
            'Nome': nome,
            'Categoria': categoria,
...
# Requisito 3.2.5: Função ler(lista, id) - Busca por ID [cite: 31]
...
# Requisito 3.2.6: Função atualizar(lista, id) [cite: 32]
...
# Requisito 3.2.7: Função deletar(lista, id) [cite: 33]
...
# Requisito 3.3: Menu no Terminal [cite: 34, 35]
def menu():
    while True:
